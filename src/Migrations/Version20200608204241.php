 ...
 */
final class Version20200608204241 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE occupancy ADD ltParker INT DEFAULT NULL, DROP lt_parker');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE occupancy ADD lt_parker VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP ltParker');
    }
}
